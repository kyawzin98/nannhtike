    ...
    <div class="sidebar">
        <div class="d-flex hv-100 align-items-stretch">
            ...
            <div class="tab-content flex-grow-1" id="v-pills-tabContent">
                    ...
                    <ul class="sidebar-menu">
                        <li class="treeview"><a href="#">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="panel-page-dashboard10.html"><i class="icon icon-folder5"></i>Panel
                                        Dashboard 10</a></li>
                                <li><a href="panel-page-dashboard11.html"><i class="icon icon-folder5"></i>Panel
                                        Dashboard 11</a></li>
                            </ul>
                        </li>
                        <li class="treeview"><a href="#">
                        ...
                        <li class="treeview"><a href="#"><i class="icon icon-account_box s-24"></i>Users<i
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="panel-page-profile.html"><i class="icon icon-user"></i>User Profile
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="treeview"><a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="panel-page-inbox.html"><i class="icon icon-circle-o"></i>All
                                        Messages</a>
                                </li>
                        ...
                        <li class="treeview ">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="panel-page-contacts.html"><i
                                                class="icon icon-circle-o"></i>Contacts</a>
                                </li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="panel-element-badges.html"><i
                                                class="icon icon-flag7 amber-text s-14"></i>
                        ...
                        <li class="treeview ">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="panel-element-date-time-picker.html"><i
                                                class="icon icon-date_range light-green-text"></i>Date Time
                                        Picker</a>
                                </li>
                                ...
                                <li><a href="panel-element-select2.html"><i
                                                class="icon  icon-one-finger-click light-green-text"></i>Select
                                        2</a>
                                </li>
                ...
                <di class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                    ...
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="{{asset('/')}}/assets/img/dummy/u1.png"
                                                     alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                ...
                                <li class="my-1">
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="{{asset('/')}}/assets/img/dummy/u6.png"
                                                     alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                ...
                                <li class="my-1">
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="{{asset('/')}}/assets/img/dummy/u2.png"
                                                     alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                ...
                                <li class="my-1">
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="{{asset('/')}}/assets/img/dummy/u3.png"
                                                     alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                ...
                                <li class="my-1">
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="{{asset('/')}}/assets/img/dummy/u4.png"
                                                     alt="User Image">
                                            </div>
                                            <div>
                                                <div>
